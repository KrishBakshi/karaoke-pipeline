...
def  _get_name_params(model_path , model_hash):
    ...
    if model_hash == '47939caf0cfe52a0e81442b85b971dfd':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_44100.json')
        param_name_auto=str('4band_44100')
    if model_hash == '4e4ecb9764c50a8c414fee6e10395bbe':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_v2.json')
    ...
    if model_hash == '6dd9eaa6f0420af9f1d403aaafa4cc06':   
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_v2_sn.json')
    ...
    if model_hash == '5c7bbca45a187e81abbbd351606164e5':
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/3band_44100_msb2.json')
    ...
    if model_hash == '68aa2c8093d0080704b200d140f59e54':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/3band_44100.json')
        param_name_auto=str('3band_44100.json')
    if model_hash == 'fdc83be5b798e4bd29fe00fe6600e147':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/3band_44100_mid.json')
    ...
    if model_hash == '89e83b511ad474592689e562d5b1f80e':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/2band_32000.json')
    ...
    if model_hash == '6a00461c51c2920fd68937d4609ed6c8':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/1band_sr16000_hl512.json')
        param_name_auto=str('1band_sr16000_hl512')
    if model_hash == '0ab504864d20f1bd378fe9c81ef37140':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/1band_sr32000_hl512.json')
    ...
    if model_hash == 'edc115e7fc523245062200c00caa847f':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/1band_sr33075_hl384.json')
    ...
    if model_hash == 'b58090534c52cbc3e9b5104bad666ef2':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/1band_sr44100_hl512.json')
    ...
    if model_hash == 'ae702fed0238afb5346db8356fe25f13':  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/1band_sr44100_hl1024.json')
    ...
    if '1band_sr44100_hl256' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/1band_sr44100_hl256.json')
    ...
    if '2band_44100_lofi' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/2band_44100_lofi.json')
    ...
    if '2band_48000' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/2band_48000.json')
    ...
    if '4band_44100_mid' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_44100_mid.json')
        param_name_auto=str('4band_44100_mid')
    if '4band_44100_msb' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_44100_msb.json')
        param_name_auto=str('4band_44100_msb')
    if '4band_44100_msb2' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_44100_msb2.json')
        param_name_auto=str('4band_44100_msb2')
    if '4band_44100_reverse' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_44100_reverse.json')
        param_name_auto=str('4band_44100_reverse')
    if '4band_44100_sw' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/4band_44100_sw.json') 
    ...
    if 'tmodelparam' in ModelName:  
        model_params_auto=str('uvr/uvr5_pack/lib_v5/modelparams/tmodelparam.json')
