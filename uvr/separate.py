...
from uvr.uvr5_pack.lib_v5 import spec_utils
from uvr.uvr5_pack.utils import _get_name_params,inference
from uvr.uvr5_pack.lib_v5.model_param_init import ModelParameters
...
class  _audio_pre_():
    def __init__(self, model_path,device,is_half):
        ...
        nets = importlib.import_module('uvr.uvr5_pack.lib_v5.nets' + f'_{nn_architecture}'.replace('_{}KB'.format(nn_arch_sizes[0]), ''), package=None)
